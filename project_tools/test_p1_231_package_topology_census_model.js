...
(function main() {
  ...
  eq(classifyPackagePath('release_builder_contract_v1.json'), 'non-package', 'builder-contract authority is control-plane, not package member');
  eq(classifyPackagePath('release_contract_inputs_v1.json'), 'non-package', 'release-contract authority is control-plane, not package member');
