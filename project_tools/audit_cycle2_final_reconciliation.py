#!/usr/bin/env python3
"""Deterministic final-reconciliation guard for Cycle-2 deep-audit coverage."""
...
MATRIX = ROOT / "project_docs" / "AUDIT_COVERAGE_CYCLE2_MATRIX_2026-08-31.md"
...
REGISTRY = ROOT / "project_docs" / "AUDIT_REGISTRY.md"
EXTERNAL = ROOT / "project_docs" / "AUDIT_EXTERNAL_USER_INTENT_BASELINE_2026-08-31.md"
...
def main() -> int:
    ...
    required_synthesis = [
        "`DEEP-AUDIT-COVERAGE-COMPLETE`",
        "`DEEP-AUDIT-CRITICAL-CLOSURE-COMPLETE` — **NO**",
        "`RELEASE-READY` — **NO**",
