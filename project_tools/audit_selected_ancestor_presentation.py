...
This is an audit harness, not an implementation. The optional normalized case is
...
def main() -> int:
    ...
    print(f"P0-004 physical selected-ancestor audit: FINDING reproduced; result={result_path}")
    return 0
