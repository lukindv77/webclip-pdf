...
const EXPECTED_IDENTITIES = Object.freeze({
  rpf: 'sha256:6b7f60999284a12040aabce4e3d9496919749a815ce4e27d3129eb06ae7249e9',
  ...
  rcf: 'sha256:4d4d22be60b3f2e94fc24282207889c124c2d726e4070bcab482163f58102f50',
...
(function main() {
  ...
  throwsCode(() => admitCandidate({ candidateSha: 'HEAD', portabilityReady: true, regeneratedOutputs: new Map(), identities }), 'CANDIDATE_SHA_INVALID');
  throwsCode(() => admitCandidate({ candidateSha: '0'.repeat(40), portabilityReady: true, regeneratedOutputs: new Map(), identities }), 'CANDIDATE_NOT_COMMIT');
  throwsCode(() => admitCandidate({ candidateSha: head, portabilityReady: true, regeneratedOutputs: new Map([['public-suffix.js', run.generated]]), identities: null }), 'IDENTITY_COMPUTATION_FAILED');
