...
old = '| C32 | Pagination / physical page breaks | `NOT-TRIAGED / UNKNOWN` |'
new = '| C32 | Pagination / physical page breaks | `L4-REVALIDATED / FINDING + POSITIVE/FORCED/ROOT-OVERRIDE/DESCENDANT-AVOID/OVERSIZED/WIDOW-ORPHAN/FRAME/RASTER/CAUSAL CONTROLS (P1-187)` |'
if old not in text:
    raise SystemExit('C32 baseline row did not match expected current text')
