...
This is research evidence, not a product repair.
"""
    ...
    for forbidden in ("javascript:", "data:", "safe", "protocol", "scheme"):
        if forbidden.lower() in block.lower():
            raise AssertionError(
                f"absolutizeLinksInIncludedContent() now contains possible scheme-safety logic ({forbidden}); re-research harness assumptions"
            )
