...
let browser; let process;
try {
  browser = await puppeteer.launch({headless:false,pipe:false,enableExtensions:[extension],args:['--no-sandbox','--disable-gpu','--disable-dev-shm-usage','--no-first-run','--no-default-browser-check']});
  ...
  if(process&&process.exitCode==null)try{process.kill('SIGTERM')}catch(_){}
