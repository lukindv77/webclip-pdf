...
check('S06 status connected is admission usability while token presence stays separate', () => { has(SOURCE, 'connected: authTruth.authUsable,'); has(SOURCE, 'authPresent: authTruth.authPresent,'); });
