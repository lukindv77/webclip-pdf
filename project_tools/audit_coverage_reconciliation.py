#!/usr/bin/env python3
"""Deterministic project-wide deep-audit coverage reconciliation gate.

This is an audit-process checker, not a product-runtime test. It verifies the durable
...
MATRIX_PATH = ROOT / "project_docs" / "AUDIT_COVERAGE_RECONSTRUCTION_2026-08-30.md"
EXTERNAL_BASELINE_PATH = ROOT / "project_docs" / "AUDIT_EXTERNAL_USER_INTENT_BASELINE_2026-08-30.md"

AUDIT_DATE = dt.date(2026, 8, 31)
...
# physical-artifact or operation-lifecycle evidence. Audit docs/tools are intentionally
...
def main() -> None:
    ...
    freshness_days = (AUDIT_DATE - external_date).days
