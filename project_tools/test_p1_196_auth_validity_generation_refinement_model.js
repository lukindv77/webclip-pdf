...
check('O02 P1-196 exact owner', () => has(REGISTRY, 'Auth validity is an explicit generation separate from token presence; stale failure/readback cannot downgrade a newer proven credential'));
