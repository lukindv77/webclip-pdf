...
check('O03 P1-178 no longer ACTIVE after auth/settings implementation', () => lacks(REGISTRY, '| P1-178 | ACTIVE |'));
...
check('O06 P1-177 implemented scheduler owner', () => has(REGISTRY, '| P1-177 | IMPLEMENTED / RELEASE-REGRESSION |'));
check('O07 P1-179 ACTIVE', () => has(REGISTRY, '| P1-179 | IMPLEMENTED / RELEASE-REGRESSION |'));
