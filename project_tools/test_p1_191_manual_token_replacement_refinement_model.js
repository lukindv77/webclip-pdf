...
check('R02 implemented P1-191 contract remains durably stated in evidence', () => has(EVIDENCE, 'Manual-token replacement must validate candidate before generation-fenced commit and preserve last proven auth on failure/unknown; old PKCE cannot later overwrite it.'));
