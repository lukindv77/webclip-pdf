...
P1-231 remains **ACTIVE**. The current canonical extension package is the 34-member `webclip-extension-package/v1` projection with RPF `sha256:3b493236e8060f2fdfdd60fc1a1078c82eb99f98757a2771fe37b68b68980673`. For the current candidate, the exact 33-member negative/control projection (the same package minus `application-generation.js`) is `sha256:4c5f04e9a2ab4caf1dacb6b7141f2c21fe5fe4af267c20e33e73d00c3ebd052c`; `sha256:2dd647a17acd570c42d09ca47f01401b81c9936b23d30f794bb873ea7e81333a` is the exact predecessor control for the baseline immediately before the recovery-runtime byte change.

The current full-RCF authority includes eleven blob roots, including `project_tools/build_public_suffix_js.py` and the canonical research Registry. After the P1-196 mandatory-row status transition, the resulting full RCF is `sha256:a099e052fdd75038f40a8895d2f91a8e63cefc545387d9ddebef8b783eb90b07`; the prior `sha256:df6709bbe06a91b39828073552c499e307d74c4aebf782b3966fb1163ebdc8ce` is the historical ten-root control. Chrome QCF remains `sha256:3715a3453333d3d679a1c1c00a0bab6a02b77c0153f1a4e8d138aa1e8f5a984c`, Yandex QCF remains `sha256:8d6c9711b4f71b8485b49a6ab68f90bcf62bc74155ae0959dbdc4718648879a1`, and BCF remains `sha256:9eebcc834fa32bd8fe5f03ef14564f0fc1c169d0308dcc2813941b4f913363ff`.
...
## P1-196 recovery per-child auth recheck — 2026-09-23

A bounded P1-196 implementation adds a secret-free exact auth receipt to the memory-only Yandex operation context, revalidates current auth usability + record/control generation before every pending-remote recovery child that still requires provider access, and exact-CASes a recovery-owned OAuth Disk 401 through the existing invalid tombstone primitive. A stale A response cannot demote newer B, and an old A recovery batch cannot silently replay later children under B. Already `remote-verified` rows remain eligible for local Journal/checkpoint finalization without OAuth.

Deterministic coverage is `project_tools/test_p1_196_recovery_auth_recheck_runtime.js`, with the existing P1-196 refinement witness reconciled to the new source shape. This implementation changes `service-worker.js`, so current RPF and current 33-file control must be re-derived by exact-head release-identity authority before merge; their pre-change values are `sha256:63ba60983ae6cce7df28f775cf64111a2d6a5d20913b22568fafc055c79856ff` and `sha256:2dd647a17acd570c42d09ca47f01401b81c9936b23d30f794bb873ea7e81333a`. P1-196 remains **ACTIVE** pending exact-head implementation evidence; manifest remains `0.9.8`; release readiness remains **NOT READY**. No live Yandex/Chrome qualification, product build, release receipt, S2 activation, tag, deployment or release decision is performed.


### P1-196 recovery auth recheck discovery #1085

Repository Integrity #1085 / run `35813179626` on exact implementation head `985cedd6cb5ebb583fc4afa03bee7f05351e7e1a` stopped the generic job at the PR change-contract metadata gate before JavaScript syntax/deterministic execution. The independent source-generation lane succeeded and derived current 34-file RPF `sha256:686505dd03013ccc9760eab3daf15062b8791cb86c4b6d13693eb6a8997d946b`; Chrome/Yandex QCF remain unchanged, full RCF remains `sha256:037cd4b167ed9c6b572b8e74ea8b355be9599c142c68bffce55e0fb386aab9ed`, and BCF remains `sha256:9eebcc834fa32bd8fe5f03ef14564f0fc1c169d0308dcc2813941b4f913363ff`. The current 33-file control is intentionally still unpinned because #1085 never ran the deterministic identity suite. #1085 is discovery evidence only, not merge evidence. P1-196 remains **ACTIVE**; manifest remains `0.9.8`; release readiness remains **NOT READY**.


### P1-196 recovery auth recheck discovery #1086

Repository Integrity #1086 / run `35813546912` on exact head `45b28d0261955d502709d9e7f260f7fe2c4f4699` passed PR-contract, JavaScript syntax and both dedicated release-control jobs, and executed the P1-196 refinement/existing auth regressions successfully. The generic deterministic suite exposed three direct reconciliation items: the new recovery regression matched a historical comment instead of an executable await, the P1-208 fairness source witness still expected the former pre-loop auth-deferral syntax, and current 33-file identity assertions still pinned predecessor `sha256:2dd647a17acd570c42d09ca47f01401b81c9936b23d30f794bb873ea7e81333a`. Exact identity execution derived current 33-file control `sha256:bc3d9d15bc389a9efc3257775ab408594ee9e6c9c9f0a2a6fbfc8c684b9da7f0`. The source-witness fixes do not change package/runtime bytes. #1086 is discovery evidence only, not merge evidence; a later complete exact-head SUCCESS is required. Current RPF remains `sha256:686505dd03013ccc9760eab3daf15062b8791cb86c4b6d13693eb6a8997d946b`; QCF/full-RCF/BCF remain unchanged; P1-196 remains **ACTIVE**; manifest remains `0.9.8`; release readiness remains **NOT READY**.


### P1-196 exact-head implementation gate #1087

Repository Integrity #1087 / run `35813852999` completed **SUCCESS** on exact P1-196 implementation head `a79144e8786a9a0d01e4fee446c78cbb2ef98b90`; all three required jobs passed, including the complete deterministic suite. The registered P1-196 source/runtime contract is therefore implemented: exact 401/expiry validity transitions are generation-fenced, stale responses cannot demote newer auth, status axes are explicit, account enrichment is exact-request CAS, invalid/expired tombstones are non-secret, and restart/maintenance recovery rechecks exact auth usability/generation before every provider-required child.

P1-196 transitions from **ACTIVE** to explicit mandatory-row status **IMPLEMENTED / RELEASE-REGRESSION**. This does not claim live Yandex qualification or release authorization. The Registry edit is a full-RCF-root change, so a new exact-head identity/CI run is required before merge. Package RPF remains `sha256:686505dd03013ccc9760eab3daf15062b8791cb86c4b6d13693eb6a8997d946b`, current 33-file control remains `sha256:bc3d9d15bc389a9efc3257775ab408594ee9e6c9c9f0a2a6fbfc8c684b9da7f0`, Chrome/Yandex QCF and BCF remain unchanged; full RCF must be re-derived on the Registry-transition head. Manifest remains `0.9.8`; release readiness remains **NOT READY**.


### P1-196 mandatory-row consistency discovery #1088

Repository Integrity #1088 / run `35814260093` on exact transition head `7728598db78d0d31e42080a77c2b64029b67f4f5` failed immediately at Repository consistency because late/reserved owners P1-195…P1-230 are required to remain explicit Registry rows. Removing the P1-196 row was therefore an invalid representation of the implemented state. The corrected transition retains P1-196 explicitly with status **IMPLEMENTED / RELEASE-REGRESSION**. #1088 is discovery evidence only and is not merge evidence.


### P1-196 Registry-transition identity discovery #1089
...
### P1-177 exact-head discovery #1093

Repository Integrity #1093 / run `35816086398` on exact head `142c8ab19082339938de2dfd6d944eaebaafe331` passed both dedicated release-control jobs but failed `repository-integrity` at Deterministic JavaScript tests. Exact source-generation authority derived current 34-file RPF `sha256:3b493236e8060f2fdfdd60fc1a1078c82eb99f98757a2771fe37b68b68980673`; deterministic identity execution derived the current 33-file negative/control projection `sha256:4c5f04e9a2ab4caf1dacb6b7141f2c21fe5fe4af267c20e33e73d00c3ebd052c`. Chrome QCF remains `sha256:3715a3453333d3d679a1c1c00a0bab6a02b77c0153f1a4e8d138aa1e8f5a984c`, Yandex QCF remains `sha256:8d6c9711b4f71b8485b49a6ab68f90bcf62bc74155ae0959dbdc4718648879a1`, full RCF remains `sha256:a099e052fdd75038f40a8895d2f91a8e63cefc545387d9ddebef8b783eb90b07`, and BCF remains `sha256:9eebcc834fa32bd8fe5f03ef14564f0fc1c169d0308dcc2813941b4f913363ff`.

The 17 deterministic failures reduce to three direct reconciliation classes: stale current RPF/current 33-file pins with downstream predecessor failures; the P1-076/P1-077 witness still expecting direct fixed-alarm calls instead of the new generation-admitted dispatcher; and the P1-196 extracted-source harness lacking the new `initializeJournalBackupScheduler` helper used after successful connection proof. #1093 is discovery evidence only, not merge evidence. P1-177 remains **ACTIVE** because per-later-child remote admission recheck is still outside this tranche; manifest remains `0.9.8`; release readiness remains **NOT READY**.

### P1-177 per-child remote admission tranche

Canonical starting point for this tranche is post-merge `main=a74f085141a64212d61ab21428824f47cc375ffa` after PR #345. Repository Integrity #1095 / run `35891591416` completed **SUCCESS** on that exact main for all three required jobs: `repository-integrity`, `p1-231-source-generation-authority`, and `p1-231-shadow-identity`.

This next bounded P1-177 tranche propagates the exact admitted scheduler generation into the background export pipeline, captures one immutable Yandex operation context for that admitted generation, and revalidates scheduler/auth authority immediately before later remote children. Folder provisioning requests, upload-URL acquisition, signed upload admission, recovery verification, and post-upload verification now consume the gate when the call originates from background scheduling. Manual backup remains outside scheduler authority.

The prepared backup checkpoint records the scheduler generation before signed transfer admission. If generation becomes stale before the signed transfer starts, the new prepared checkpoint is retired because no physical effect began. If Disconnect occurs after the signed transfer has started but before later verification, the checkpoint is preserved and the later child is vetoed; already-started effect truth remains for recovery/reconciliation rather than being reported as cancelled.

A stale/paused child veto is mapped to a successful `skipped` background outcome before ordinary backup failure bookkeeping, so it does not create `lastFailureAt` / `lastBackgroundFailureAt` churn or authorize a retry. Real settlement of an already-started effect remains historical fact and is not rewritten by scheduler pause.
...
Because `service-worker.js` changes, final current RPF/33-file-control values must come from exact-head identity authority and are not guessed here. Manifest remains `0.9.8`; release readiness remains **NOT READY**. No live Yandex request, real Chrome qualification, physical release receipt, ZIP/build, S2 activation, tag, deployment, GitHub Release or release decision is performed.
