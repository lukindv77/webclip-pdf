...
P1-231 remains **ACTIVE**. The current canonical extension package is the 34-member `webclip-extension-package/v1` projection with RPF `sha256:880ad517fda59415bfcfcb476e29139718d386db708bd652b67c3c10aa38ecff`. For the current candidate, the 33-member legacy-subset control (the same package minus `application-generation.js`) is `sha256:710d9a44279541adb6ef609b9cad4b34beba17610fb585e668fc1376c362b623`; `sha256:b65c38854c016ce3ea88efd1caf5c3291a3089336ba9d58b01b9f86db73b835a` is the historical predecessor value for that subset before the later package-byte changes.
