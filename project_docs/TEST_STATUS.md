...
This is still a **partial P0-079 implementation**. P0-023 now supplies the separate live-page source-admission fence described below, but P1-198 trusted live operation identity and stronger recovery/retention composition remain separate owners. P0-079, P0-023, P0-070 and P0-080 remain **ACTIVE**; release readiness remains **NOT READY**.
