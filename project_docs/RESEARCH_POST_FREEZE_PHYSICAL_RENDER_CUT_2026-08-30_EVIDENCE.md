# Durable research evidence — post-freeze physical render cut — 2026-08-30

Canonical status and single-owner authority remain exclusively in `RESEARCH_REGISTRY.md`. This file is the interruption-safe working evidence for a source-first deep-research tranche on mutations that can occur after save admission/preparation and before or during the physical Chromium `Page.printToPDF` render.

## Interruption-safe baseline

- Fresh researched `main`: `2b2522130792d8d023b540216f9742c3f7226d2e`.
...
- PR #26 is research/docs-only and does not alter the runtime source being researched here.
