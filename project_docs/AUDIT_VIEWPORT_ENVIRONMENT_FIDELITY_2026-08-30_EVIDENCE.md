# Durable audit evidence — viewport/environment fidelity — Blocks 1–16 — 2026-08-30

Canonical current status remains exclusively in `AUDIT_REGISTRY.md`. This file is an interruption-safe fresh-source checkpoint focused on the product goal: save user-selected page content for later reading with the same rendered presentation as the source, except where a deliberately different capture mode is explicit and truthful.

Fresh audited baseline: `main = 4d26fb5b6481861d0f11f37e8c3c8746afb5b6ab`.

Working branch: `audit/viewport-environment-fidelity-2026-08-30`.

No runtime, `AUDIT_REGISTRY.md`, manifest/version, build/tag/release state changes in this checkpoint.
