...
Canonical P-code status/owner authority remains exclusively in `AUDIT_REGISTRY.md`. This file records the post-audit reconciliation caused by concurrent PR #47 landing while PR #46 was in delivery. It changes no runtime source, registry status, manifest/version, build, tag or GitHub Release.

## Source state

- PR #46 original audited base: `32e9672542482ba2a58d90258750261af75c5576`.
