# WebClip — initial deep-research coverage reconstruction — 2026-08-30

Date: 2026-08-30

Baseline canonical `main`: `bcf310b13dd8584d2e0d66ae4007b511a859843d`.

Stage-2 C22/C23 revalidation researched canonical `main`: `a0e1252317dfa1a1146dbed0e5b8bfe5bb760491`.

Stage-3 C26 hover-exclusion revalidation researched canonical `main`: `153d09c164473643229b29946dc35ba413715913`.

Stage-4 C24 inert-disclosure revalidation researched canonical `main`: `0ecfff217d8cc81099fadd9476532d8d7d845f28`.

Stage-5 C02 SelectionSnapshot restore -> physical-PDF revalidation researched canonical `main`: `07df33f5d1ed572bd4da3083411aef9dd94d21c0`.

Stage-6 C03 Main Content / auto candidate -> physical-PDF revalidation researched canonical `main`: `869c47b14254fdadded1e24dc6a6bfabafc049a1`.

Purpose: первая фактическая реконструкция deep-research Coverage Matrix из уже существующих durable research evidence, registry/history и merged physical-browser tranches. Этот документ **не заменяет P-code owner/status authority**: `RESEARCH_REGISTRY.md` остаётся единственным canonical authority. Coverage rows ниже фиксируют achieved evidence/outcome и должны обновляться после targeted tranches.

Методика задаётся `RESEARCH_COVERAGE_CAMPAIGN_POLICY.md`. PDF acceptance задаётся `WEBCLIP_PDF_FIDELITY_CONTRACT.md`.

## 1. Источники реконструкции

Current authority/context:

- `RESEARCH_REGISTRY.md` — единственный current authority по P-code owner/status;
- `RESEARCH_DELTA_INDEX.md` — navigation по supplemental durable research evidence;
- `RESEARCH_HISTORY_INDEX.md` — corrections/retractions/negative controls/status traps;
...
Основные recent physical/render research tranches, реконструированные здесь:

- PR #35 / `RESEARCH_SAVED_COPY_READABILITY_2026-08-30_EVIDENCE.md`;
- PR #36 / `RESEARCH_DEFERRED_VIRTUALIZED_MATERIALIZATION_2026-08-30_EVIDENCE.md`;
- PR #37 / `RESEARCH_LONGPAGE_TOPLAYER_PAGINATION*_2026-08-30_EVIDENCE.md`;
- PR #38 / `RESEARCH_COMPOSED_RENDERED_SCOPE_CONVERGENCE*_2026-08-30_EVIDENCE.md`;
- PR #39 / `RESEARCH_REPLACED_RESOURCE_CONVERGENCE*_2026-08-30_EVIDENCE.md`;
- PR #40 / `RESEARCH_CSS_VISUAL_DEPENDENCY_GRAPH*_2026-08-30_EVIDENCE.md`;
- PR #41 / `RESEARCH_FLATTENED_DOCUMENT_NAMESPACE*_2026-08-30_EVIDENCE.md`;
- PR #42 / `RESEARCH_TYPOGRAPHY_LAYOUT_FIDELITY*_2026-08-30_EVIDENCE.md`;
- PR #43 / `RESEARCH_FLATTENED_CSS_NAMED_ENVIRONMENT*_2026-08-30_EVIDENCE.md`;
- PR #44 / `RESEARCH_VIEWPORT_ENVIRONMENT_FIDELITY*_2026-08-30_EVIDENCE.md`;
- PR #45 / `RESEARCH_TEMPORAL_RENDER_STATE_FIDELITY*_2026-08-30_EVIDENCE.md`;
- PR #46 / `RESEARCH_RESPONSIVE_REPLACED_MEDIA_FIDELITY*_2026-08-30_EVIDENCE.md`;
- PR #47 / `RESEARCH_RESPONSIVE_IMAGE_CAPTURE_IDENTITY*_2026-08-30_EVIDENCE.md`;
- PR #48 / `RESEARCH_FOCUS_INTERACTION_STATE_FIDELITY*_2026-08-30_EVIDENCE.md`;
- C22/C23 targeted tranche / `RESEARCH_USER_REACHED_DYNAMIC_SCROLL_2026-08-30_EVIDENCE.md` plus its two managed-Chromium physical probes;
- C26 targeted tranche / `RESEARCH_HOVER_EXCLUSION_CONTRACT_2026-08-30_EVIDENCE.md` plus `project_tools/research_hover_exclusion_contract.py`;
- C24 targeted tranche / `RESEARCH_INERT_DISCLOSURE_CONTRACT_2026-08-30_EVIDENCE.md` plus `project_tools/research_inert_disclosure_contract.py`;
- C02 targeted tranche / `RESEARCH_SELECTION_RESTORE_PHYSICAL_PDF_2026-08-31_EVIDENCE.md` plus `project_tools/research_selection_restore_physical_pdf.py`;
- C03 targeted tranche / `RESEARCH_MAIN_CONTENT_PHYSICAL_PDF_2026-08-31_EVIDENCE.md` plus `project_tools/research_main_content_physical_pdf.py`.

Также использованы supplemental summaries из `RESEARCH_DELTA_INDEX.md`, включая selection/admission, selected-only cascade, post-freeze render cut, print rollback, local prepare budgets, source URL minimization, PDF byte transfer receipt и связанные Yandex/Journal/recovery boundaries.
...
## 4. Что уже можно считать сильной стороной текущего research evidence
...
- historical researchs сохраняют positive/negative/rejected controls, что снижает риск повторного открытия отвергнутых broad hypotheses;
...
По `RESEARCH_COVERAGE_CAMPAIGN_POLICY.md` следующий корректный шаг — **Coverage Reconciliation -> Final Synthesis candidate gate**, а не автоматическое углубление уже root-cause-saturated finding.
...
Только после этого отдельного reconciliation gate допустим transition из `DEEP-RESEARCH-IN-PROGRESS` в `DEEP-RESEARCH-COVERAGE-COMPLETE`. Такой transition **не закрывает ACTIVE findings и не означает RELEASE-READY**.
...
- project-wide state decision: остаётся `DEEP-RESEARCH-IN-PROGRESS` либо переходит в `DEEP-RESEARCH-COVERAGE-COMPLETE` с явным объяснением, почему ACTIVE findings и L5 boundaries этому не противоречат.

Нельзя объявлять `DEEP-RESEARCH-CRITICAL-CLOSURE-COMPLETE` или `RELEASE-READY` из этого coverage transition: это отдельные gates.