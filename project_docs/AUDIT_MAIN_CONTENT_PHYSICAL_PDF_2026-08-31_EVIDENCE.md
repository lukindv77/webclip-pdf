# Durable audit evidence — C03 Main Content / auto candidate -> final physical PDF — 2026-08-31

Canonical status and single-owner authority remain exclusively in `AUDIT_REGISTRY.md`.

Audited fresh source baseline: `main = 869c47b14254fdadded1e24dc6a6bfabafc049a1`.
...
No runtime, `manifest.json`, version/build/tag/release state is changed by this audit tranche.
...
Durable probe: `project_tools/audit_main_content_physical_pdf.py`.
...
```bash
python3 project_tools/audit_main_content_physical_pdf.py
```
