# Durable research evidence — responsive image capture identity — Blocks 1–16 — 2026-08-30

Canonical P-code owner/status authority remains exclusively in `RESEARCH_REGISTRY.md`. This is an interruption-safe fresh-source checkpoint focused on responsive-image candidate identity across user-admitted screen state, resource preparation, selected-frame normalization, same-origin flattened representation and physical PDF generation.

Exact fresh researched baseline: `main = 309dd6e446dbcc7188215fdbf979478cec645c96`.

Working branch: `research/responsive-image-capture-identity-2026-08-30`.
...
PR #39 / `RESEARCH_REPLACED_RESOURCE_CONVERGENCE_2026-08-30_EVIDENCE.md` already owns three nearby negative controls and remains authoritative for them:
