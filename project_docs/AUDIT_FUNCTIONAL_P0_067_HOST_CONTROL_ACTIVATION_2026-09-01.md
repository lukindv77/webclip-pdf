...
Canonical owner authority: `AUDIT_REGISTRY.md` → **P0-067 ACTIVE** — PDF preparation must not synthesize real host-page control activation with submit/navigation/destructive side effects.
...
Durable harness: `project_tools/audit_host_control_activation.py`.
