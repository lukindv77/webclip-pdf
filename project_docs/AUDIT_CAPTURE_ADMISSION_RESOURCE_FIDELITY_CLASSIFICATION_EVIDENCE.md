...
This file is durable audit evidence only. `AUDIT_REGISTRY.md` remains the sole authority for current P-code status and ownership.

Source baseline for the audited runtime: `main` at `f9ff401c3521433ffee40b8d48390c2477a018cb`.
