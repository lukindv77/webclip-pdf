# Research family evidence — Local download / native Save As / file settlement

Family from `RESEARCH_DELTA_INDEX.md` section 9.
...
|---|---|---|---|
| `RESEARCH_DELTA_FILENAME_COLLISION_RECOVERY_2026-08-27.md` | `9a7eaf2af507d71d2c951b4a775ea6436895fcb6afedc6f39b37c1ecbde04958` | P0-006, P0-039, P0-048, P0-079, P1-184, P1-198, P2-020 | Research delta — filename collision / recovery identity — 2026-08-27 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_ACTUAL_FILENAME_2026-08-27.md` | `651df187ee69199bd7da80a079e771c1e213655fb7753783900b7fa21d33b85b` | P0-039, P0-048, P0-079, P1-146, P1-198, P1-199, P1-200, P1-201, P1-202 | Research delta — actual local-download filename / recovery receipt — 2026-08-27 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_INTERRUPTED_LIFECYCLE_2026-08-27.md` | `3bbd99b89eae78a5d53f06a3f65574d54927cb773c930cda9b6113f52d9f4fc0` | P0-039, P0-048, P0-072, P0-076, P1-067, P1-087, P1-146, P1-198, P1-199, P1-200, P1-201 | Research delta — local DownloadItem interrupted/resumable lifecycle — 2026-08-27 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_KNOWN_ID_BIND_FAILURE_2026-08-28.md` | `f1d1809fff1b7cbc70b0d8c0d342371d650b367f871f2fb395343e6cb5c2a22c` | P0-039, P0-048, P1-146, P1-194, P1-211 | Research delta — known Chrome downloadId must survive durable bind failure — 2026-08-28 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_OPERATION_ID_COLLISION_2026-08-27.md` | `698947d14d2e2faaae5af62719d8e9a0451dd49a2487ceb81b2cf71d3282902f` | P0-023, P0-039, P0-048, P0-070, P0-072, P0-076, P0-079, P0-080, P1-146, P1-198 | Research delta — local PDF/download operation identity collision — 2026-08-27 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_RECOVERY_2026-08-27.md` | `2a26597d9296c5084115225e5135dd4ca692dde31bb2b4e889560dc562d49bbb` | P0-039, P0-048, P0-072, P0-079, P1-067, P1-087, P1-146, P1-195, P1-196, P1-197, P2-020 | Local download recovery research delta — 2026-08-27 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_RECOVERY_FAIRNESS_2026-08-27.md` | `5489515b38c73984f167dc1423e31b62d92956205e0913c3bfb021a89fcd186e` | P0-039, P1-064, P1-087, P1-146, P1-200 | Research delta — local download recovery fairness |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_START_VS_HISTORY_RETENTION_STATES_2026-08-28.md` | `bdba1238e02b256248e93c81a8df8b14e4db85580fce386a2879f7258757ca65` | P0-039, P0-048, P1-087, P1-146, P1-211 | Research delta — local download start receipt vs DownloadItem/history retention states — 2026-08-28 |
| `RESEARCH_DELTA_LOCAL_DOWNLOAD_TERMINAL_RECEIPT_2026-08-28.md` | `3e0aec16deefbb3a24d6ab002d0a2444482f5e8f91d7760cc604f47e351b24ff` | P0-039, P0-048, P0-079, P1-067, P1-087, P1-146, P1-198, P1-210 | Research delta — exact local DownloadItem terminal receipt — 2026-08-28 |
| `RESEARCH_DELTA_NATIVE_SAVE_AS_LIFECYCLE_2026-08-28.md` | `d1703665f176c4c95a69cde916e59ba33520abe231540f29abb7d8a66f516647` | P1-067, P1-124, P1-156, P1-169, P1-201, P1-210 | Research delta — native Save As lifecycle completion — 2026-08-28 |
| `RESEARCH_DELTA_NATIVE_SAVE_AS_STARTED_VS_FILE_TERMINAL_SUCCESS_2026-08-28.md` | `51fd61e399f46cc89e690d2b3ec37989131467777b6ec52dd1456050cfabdd10` | P1-156, P1-198, P1-210, P1-211 | Research delta — native Save As STARTED is currently recorded as terminal export success — 2026-08-28 |
| `RESEARCH_DELTA_SAVE_AS_STARTED_COMMIT_ORDER_2026-08-28.md` | `ea41f318b4f2521c1040ec0925a2ce432a1e5207245608abf8f75592fe98551a` | P1-067, P1-156, P1-169, P1-210, P1-211 | Research delta — Prepared Save As STARTED commit ordering — 2026-08-28 |
...
## Retired source: `RESEARCH_DELTA_FILENAME_COLLISION_RECOVERY_2026-08-27.md`

SHA-256 of UTF-8 source text: `9a7eaf2af507d71d2c951b4a775ea6436895fcb6afedc6f39b37c1ecbde04958`

# Research delta — filename collision / recovery identity — 2026-08-27

Baseline HEAD before this research block: `8a7b4f0cb0d9acce8ee5d7db7ab5864ad753bd2a`.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_ACTUAL_FILENAME_2026-08-27.md`

SHA-256 of UTF-8 source text: `651df187ee69199bd7da80a079e771c1e213655fb7753783900b7fa21d33b85b`

# Research delta — actual local-download filename / recovery receipt — 2026-08-27
...
- **P1-199** — cross-origin iframe print `prepare-print` / `restore-print` operation-generation fencing (`RESEARCH_DELTA_CROSS_ORIGIN_PRINT_GENERATION_2026-08-27.md`);
- **P1-200** — remote frame selection/control session-generation and ordering (`RESEARCH_DELTA_REMOTE_FRAME_CONTROL_GENERATION_2026-08-27.md`);
- **P1-201** — optional host-permission revocation lifecycle (`RESEARCH_DELTA_FRAME_PERMISSION_REVOCATION_LIFECYCLE_2026-08-27.md`).

In addition, the earlier `RESEARCH_DELTA_FILENAME_COLLISION_RECOVERY_2026-08-27.md` already proved that Chrome `conflictAction:'uniquify'` can make the fallback filename check fail and explicitly classified that mechanism under existing **P0-048 / P0-039**, with no new number.
...
This mechanism was already documented in `RESEARCH_DELTA_FILENAME_COLLISION_RECOVERY_2026-08-27.md` and remains owned by P0-048/P0-039.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_INTERRUPTED_LIFECYCLE_2026-08-27.md`

SHA-256 of UTF-8 source text: `3bbd99b89eae78a5d53f06a3f65574d54927cb773c930cda9b6113f52d9f4fc0`

# Research delta — local DownloadItem interrupted/resumable lifecycle — 2026-08-27
...
This research does **not** claim that Chrome necessarily exposes `canResume:true` for WebClip's Blob-backed DownloadItems in the target Chrome build. That must be verified in real unmanaged unpacked Chrome before implementation semantics are finalized or a separate root-cause number is considered.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_KNOWN_ID_BIND_FAILURE_2026-08-28.md`

SHA-256 of UTF-8 source text: `f1d1809fff1b7cbc70b0d8c0d342371d650b367f871f2fb395343e6cb5c2a22c`

# Research delta — known Chrome downloadId must survive durable bind failure — 2026-08-28
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_OPERATION_ID_COLLISION_2026-08-27.md`

SHA-256 of UTF-8 source text: `698947d14d2e2faaae5af62719d8e9a0451dd49a2487ceb81b2cf71d3282902f`

# Research delta — local PDF/download operation identity collision — 2026-08-27
...
The original P1-198 delta stated that the research had not found `operationId` used as the primary key of destructive Yandex/local checkpoints, which supported a P1 forensic/provenance classification.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_RECOVERY_2026-08-27.md`

SHA-256 of UTF-8 source text: `2a26597d9296c5084115225e5135dd4ca692dde31bb2b4e889560dc562d49bbb`

# Local download recovery research delta — 2026-08-27

Baseline source HEAD: `ff576e5f76dc64048e60e38233ef197e73c56838`.

This is a lossless research checkpoint for existing recovery items. It is not a canonical registry replacement and does not assign a new P-number. Production/runtime/config/manifest are unchanged by this commit.
...
After the 15-minute automatic-download resource deadline, WebClip checks `downloads.search({id})`; for in-progress or unknown state it makes a bounded best-effort `chrome.downloads.cancel(id)` attempt and then releases the Blob URL. The cancel promise itself can time out locally, but the accepted P1-067 contract explicitly chooses bounded resource lifetime after a cancel attempt. This research does not reclassify that trade-off as a new issue.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_RECOVERY_FAIRNESS_2026-08-27.md`

SHA-256 of UTF-8 source text: `5489515b38c73984f167dc1423e31b62d92956205e0913c3bfb021a89fcd186e`

# Research delta — local download recovery fairness

Date: 2026-08-27
Source-of-truth `main` immediately before write: `c61d56e10094662514b268b287a1c5be685bf692`.

Docs-only research checkpoint. Production runtime and `manifest.json` are unchanged. Canonical registry synchronization is not claimed by this file.
...
## Positive control from the same research block
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_START_VS_HISTORY_RETENTION_STATES_2026-08-28.md`

SHA-256 of UTF-8 source text: `bdba1238e02b256248e93c81a8df8b14e4db85580fce386a2879f7258757ca65`

# Research delta — local download start receipt vs DownloadItem/history retention states — 2026-08-28
...
Fresh source proof refines **P0-039**, **P0-048**, **P1-146**, **P1-087** and the compact detached-evidence contract recorded in the preceding research session.
...
This composes directly with the prior `RESEARCH_DELTA_COMPACT_DETACHED_RECEIPT_RETENTION_2026-08-28.md` architecture.
...
## Retired source: `RESEARCH_DELTA_LOCAL_DOWNLOAD_TERMINAL_RECEIPT_2026-08-28.md`

SHA-256 of UTF-8 source text: `3e0aec16deefbb3a24d6ab002d0a2444482f5e8f91d7760cc604f47e351b24ff`

# Research delta — exact local DownloadItem terminal receipt — 2026-08-28
...
Current event listener also sends every `interrupted` delta directly to finalization/cleanup. The interrupted-lifecycle research already proves that Chrome's exact DownloadItem can carry `canResume` and stronger bytes/error/state information.
...
## Retired source: `RESEARCH_DELTA_NATIVE_SAVE_AS_LIFECYCLE_2026-08-28.md`

SHA-256 of UTF-8 source text: `d1703665f176c4c95a69cde916e59ba33520abe231540f29abb7d8a66f516647`

# Research delta — native Save As lifecycle completion — 2026-08-28
...
## Retired source: `RESEARCH_DELTA_NATIVE_SAVE_AS_STARTED_VS_FILE_TERMINAL_SUCCESS_2026-08-28.md`

SHA-256 of UTF-8 source text: `51fd61e399f46cc89e690d2b3ec37989131467777b6ec52dd1456050cfabdd10`

# Research delta — native Save As STARTED is currently recorded as terminal export success — 2026-08-28
...
## Retired source: `RESEARCH_DELTA_SAVE_AS_STARTED_COMMIT_ORDER_2026-08-28.md`

SHA-256 of UTF-8 source text: `ea41f318b4f2521c1040ec0925a2ce432a1e5207245608abf8f75592fe98551a`

# Research delta — Prepared Save As STARTED commit ordering — 2026-08-28
