# Durable research evidence — responsive/replaced-media fidelity — Blocks 17–32 — 2026-08-30

Continuation of `RESEARCH_RESPONSIVE_REPLACED_MEDIA_FIDELITY_2026-08-30_EVIDENCE.md` from exact base `32e9672542482ba2a58d90258750261af75c5576` on branch `research/responsive-replaced-media-fidelity-2026-08-30`.

This checkpoint is docs/evidence only. Canonical P-code status remains exclusively in `RESEARCH_REGISTRY.md`. Managed Chromium/CDP and local PDF raster probes are engineering evidence, not real unpacked-Chrome release QA.
