# Durable research evidence — print rollback / retry convergence — 2026-08-30

Canonical status and single-owner authority remain exclusively in `RESEARCH_REGISTRY.md`. This document preserves a completed **32-block** source-first correctness research focused on how PDF preparation converges after partial success, failed cleanup and retry. Cybersecurity questions are intentionally outside this tranche.

Exact fresh source baseline: `main = e01c20785df5c934caa045458647c363f1df857b`.

Working branch: `research/print-rollback-retry-convergence-20260830`.
...
This tranche does **not** reopen the already completed 56-block physical-render-cut research. It starts from the later question: after a preparation attempt succeeds partially or cleanup is uncertain, does the next attempt begin from a proven clean baseline?
...
`RESEARCH_REGISTRY.md` should remain unchanged in this docs-only tranche. Material owner impact for the PR is:
