...
WebClip opportunity: a separately named complete-static mode could make more aggressive disclosure/scroll/lazy materialization deliberate and auditable rather than silently changing another format/mode's semantics.
