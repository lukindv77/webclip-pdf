...
- temporary evidence branch: `audit/fresh-c06-colors-compositing-2026-09-01`;
...
This checkpoint changes audit evidence/coverage only:

- no product runtime change;
- no `AUDIT_REGISTRY.md` status/owner change;
