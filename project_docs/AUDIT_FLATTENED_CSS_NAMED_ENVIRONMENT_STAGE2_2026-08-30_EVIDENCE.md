# Durable audit evidence — flattened-frame CSS named environment / isolation repair — Stage 2 — 2026-08-30

This file preserves **Blocks 17–32** of the fresh audit whose Blocks 1–16 are in `AUDIT_FLATTENED_CSS_NAMED_ENVIRONMENT_2026-08-30_EVIDENCE.md`.

Exact audited baseline remains `main = 4d26fb5b6481861d0f11f37e8c3c8746afb5b6ab`; production runtime is unchanged during this docs-only tranche. Managed Chromium is `144.0.7559.96`. Physical PDFs use worker-equivalent screen-media CDP printing.

Canonical status remains exclusively in `AUDIT_REGISTRY.md`. No new P-code or status transition is made here.
