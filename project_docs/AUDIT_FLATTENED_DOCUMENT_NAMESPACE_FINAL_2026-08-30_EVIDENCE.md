# Durable audit evidence — flattened document namespace fidelity — consolidated final — 2026-08-30

Canonical P-code owner/status authority remains exclusively in `AUDIT_REGISTRY.md`. This document is the compact current-tree representation of the completed **56-block** same-origin flattened-document namespace audit. It replaces four interruption-safe checkpoints while preserving their exact historical bytes through Git provenance.

No runtime source, registry row, manifest/version/build/tag/release state is changed by this compaction. Audit findings are retained as historical/regression evidence; current owner status is reconciled below rather than copied from the older checkpoints.
...
|---|---|---|
| 1–16 | `project_docs/AUDIT_FLATTENED_DOCUMENT_NAMESPACE_2026-08-30_EVIDENCE.md` | `f27442b95e2528c63c0a0e974a5a26c8c69f859c` |
| 17–32 | `project_docs/AUDIT_FLATTENED_DOCUMENT_NAMESPACE_STAGE2_2026-08-30_EVIDENCE.md` | `f083b46aa6260fd19dfc446275592890582ce960` |
| 33–48 | `project_docs/AUDIT_FLATTENED_DOCUMENT_NAMESPACE_STAGE3_2026-08-30_EVIDENCE.md` | `8ca747bfea509f3da38098cf109f04d541395d39` |
| 49–56 | `project_docs/AUDIT_FLATTENED_DOCUMENT_NAMESPACE_FINAL_2026-08-30_EVIDENCE.md` | `ea57fb2663a9b12036ced7c9465defc5102f7466` |
...
Original audited source baseline: `main = 013bea563f504a325f501ecc4521b1e41cdd11ef`.
...
- **P0-068 DONE** — the current canonical flattened-proxy inertness/duplicate-identity root; its Chrome 152 closure is retained in `AUDIT_P0_068_INERT_FRAME_PROXY_CLOSURE_2026-09-01_EVIDENCE.md`.
