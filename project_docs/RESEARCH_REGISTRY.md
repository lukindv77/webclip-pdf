...
| P1-179 | ACTIVE | Backup lease, pending checkpoint and scheduler success/failure/last-path state are immutable account/root namespaces; legacy flat state cannot become current authority. Same-account old-root read-only historical reconciliation remains open. |
