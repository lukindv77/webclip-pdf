...
| P1-164 | ACTIVE | Standalone revoke, delete-time `revoke + keep-file`, and explicit two-effect `revoke + Trash` now use durable phase/identity/Journal authority; admitted unpublish or move is never replayed, while live Yandex qualification and manual-resolution closure remain. |
