...
This is the compact current representation of the completed 2026-08-30 composed/rendered-scope convergence research tranche.

Current P-code status and single-owner authority come **only** from `project_docs/RESEARCH_REGISTRY.md`. The original interruption-safe checkpoint files remain byte-for-byte recoverable from Git history and are verified by `project_tools/test_staged_evidence_compaction.py`.
...
|---|---:|---|
| `project_docs/RESEARCH_COMPOSED_RENDERED_SCOPE_CONVERGENCE_2026-08-30_EVIDENCE.md` | 1–20 | `cb97d2be0675a76da0209c8c7044043cf7efa910` |
| `project_docs/RESEARCH_COMPOSED_RENDERED_SCOPE_CONVERGENCE_STAGE2_2026-08-30_EVIDENCE.md` | 21–32 | `7002fafcb2899e7fa811988f09ae23726479cec4` |
| `project_docs/RESEARCH_COMPOSED_RENDERED_SCOPE_CONVERGENCE_STAGE3_2026-08-30_EVIDENCE.md` | 33–44 | `afcbbd355ff39af1c0d829515d03a44dea878052` |
| `project_docs/RESEARCH_COMPOSED_RENDERED_SCOPE_CONVERGENCE_FINAL_2026-08-30_EVIDENCE.md` | 45–56 | `4e36a6d7c7418c2bb8c9a7de6299bfc414ef408b` |

The historical tranche itself was researched from exact fresh baseline `edb5f04835a61fca370587e0186c8c03c09217b9` using managed Chromium 144 engineering probes. Those probes are not substitutes for real unpacked-Chrome release QA.
...
The tranche remains evidence refining existing rendered-scope, selection-generation, resource, locator/privacy, bounded-discovery and frame-topology owners. Owner references preserved for navigation are `P0-004`, `P0-070`, `P0-075`, `P1-001`, `P1-003`, `P1-004`, `P1-160`, `P1-167`, `P1-182`, `P1-193`, `P1-227` and `P1-228`. Any present-day ACTIVE/DONE/MERGED/BACKLOG interpretation of those references must be read from `RESEARCH_REGISTRY.md`.
