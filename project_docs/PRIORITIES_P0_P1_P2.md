...
The exact pre-consolidation priority table (historical range through P1-194) is preserved in Git history at commit:

`745207cb7886bbc6d9369bac7c527218e1aaf4ab`
...
Permanent numbering rule: any P-code ever assigned in current registry or Git history remains reserved forever; gaps are not implicitly free.
