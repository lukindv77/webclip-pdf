# Durable research evidence — SelectionSnapshot restore soundness / remote settlement / bounded locator work — 2026-08-30

Canonical status and single-owner authority remain exclusively in `RESEARCH_REGISTRY.md`. This document preserves fresh-source proof, managed-Chromium reproductions, positive/negative controls, duplicate/root-cause classification and acceptance criteria for a 36-block deep-research tranche focused on truthful SelectionSnapshot restore.

Researched fresh source baseline: `main` at `e18163436b169b9945e5da966481a82a3fe54694`.
...
Therefore this research does not claim an unbounded durable/imported list. Any future acceptance must preserve this fail-closed worker boundary.
