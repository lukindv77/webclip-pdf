# Durable research evidence — frozen screen-geometry causal controls — Blocks 33–48 — 2026-08-30
...
Canonical owner/status authority remains `RESEARCH_REGISTRY.md`. Research/docs only.
