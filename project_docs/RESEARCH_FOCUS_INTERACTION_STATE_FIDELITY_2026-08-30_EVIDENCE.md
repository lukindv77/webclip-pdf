# Durable research evidence — focus / interaction-state fidelity — Blocks 1–16 — 2026-08-30

Canonical P-code owner/status authority remains exclusively in `RESEARCH_REGISTRY.md`. This is an interruption-safe fresh-source checkpoint focused on whether WebClip preserves the visual/application state that depends on focus when the user proceeds from a selected page into the save UI and physical PDF generation.

Exact fresh researched baseline: `main = ff6142135cb7103ed2b9f9a2bf3dd1dadd750454`.

Working branch: `research/focus-interaction-state-fidelity-2026-08-30`.
...
- the earlier complex-layout frame research already owns the flattened `<select>` case under **P1-187** and retained range/progress as positive controls;
