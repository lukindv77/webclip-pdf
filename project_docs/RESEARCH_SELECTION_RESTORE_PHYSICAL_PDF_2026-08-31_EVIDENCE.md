...
The earlier `RESEARCH_SELECTION_RESTORE_SOUNDNESS_2026-08-30_EVIDENCE.md` remains the detailed restore/candidate/session evidence. This file adds only the missing final-physical-artifact bridge and owner reconciliation.

No production runtime, `manifest.json`, version/build/tag/release state is changed by this research tranche.
...
Durable probe: `project_tools/research_selection_restore_physical_pdf.py`.
...
- Fixed-prefix candidate-set false confidence was already classified in `RESEARCH_SELECTION_RESTORE_SOUNDNESS_2026-08-30_EVIDENCE.md` as P1-001/P1-168 supporting work rather than a new restore owner.
...
```bash
python3 project_tools/research_selection_restore_physical_pdf.py
```
