# Durable research evidence — mandatory hover exclusion contract — C26 — 2026-08-30

Canonical P-code owner/status authority remains exclusively in `RESEARCH_REGISTRY.md`.

Exact fresh researched runtime baseline: `main = 153d09c164473643229b29946dc35ba413715913`.

Working branch: `research/hover-exclusion-contract-2026-08-30`.
...
C26 is now research-complete at the required current engineering evidence level as:

**`ARTIFACT-COVERED / FINDING`**.

This does not mean implementation is fixed.

Future closure/re-research for the relevant existing owners must prove:
