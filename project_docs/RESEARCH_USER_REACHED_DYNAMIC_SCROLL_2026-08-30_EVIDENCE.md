# WebClip — user-reached dynamic scroll / virtualized history research — 2026-08-30

Date: 2026-08-30

Exact researched canonical baseline: `a0e1252317dfa1a1146dbed0e5b8bfe5bb760491`.

Research branch: `research/user-reached-dynamic-scroll-2026-08-30`.

Coverage cells: **C22 scroll-triggered new logical content** and **C23 virtualized/windowed user-reached history** from `RESEARCH_COVERAGE_RECONSTRUCTION_2026-08-30.md`.
...
This tranche does not attempt to implement the fix. It is `RESEARCH-ONLY` under `RESEARCH_COVERAGE_CAMPAIGN_POLICY.md`.

## 3. L1 current-source proof

### 3.1 Top document has no max-user-scroll/history ledger

Fresh `content.js` source search on the researched baseline found:
...
- `project_tools/research_user_reached_dynamic_scroll.py`;
- `project_tools/research_user_reached_virtual_history.py`.
...
This research tranche reaches `ROOT-CAUSE-SATURATED` for its intended question:
