# WebClip — fresh full-project research restart — C07 fonts/typography — 2026-09-01
...
C07 researchs whether the saved physical PDF preserves the selected rendered typography and whether font readiness truthfully covers the glyphs actually needed by the selected representation.
...
That design has two separate research implications tested here:
...
This evidence changes only fresh research coverage/provenance:
