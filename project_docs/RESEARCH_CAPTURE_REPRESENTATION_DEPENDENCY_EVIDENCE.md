# Durable research evidence — capture representation dependency closure

Canonical status and single-owner authority remain exclusively in `RESEARCH_REGISTRY.md`. This document preserves source proof, managed-Chromium reproductions, negative/positive controls, dedup decisions and external architecture comparison from the 2026-08-29 capture-representation deep-research tranche.

Researched fresh source baseline: `main` at `26154e2a02a94b115d6e31e7593a2a3720834dab`.
...
The owner wording for P0-004 and P1-187 is refined in the same research delivery. Their statuses do not change.
...
This protects the research from turning every theoretically unscanned CSS URL into a defect without a valid reproduction.
...
No production runtime, manifest, version, build, tag or release is changed by this research evidence. Managed Chromium semantic probes do not replace:
...
No release-readiness claim follows from this research-only tranche.
