# Durable research evidence — typography / writing-mode / frame-proxy fidelity — 2026-08-30

Canonical current status remains exclusively in `RESEARCH_REGISTRY.md`. This file is an interruption-safe checkpoint for a fresh-source research tranche whose product target is: preserve the user-selected page content for later reading with the same rendered presentation the user saw, subject only to explicit truthful capture-mode limitations.

Fresh researched baseline: `main` = `013bea563f504a325f501ecc4521b1e41cdd11ef`.

Working branch: `research/typography-layout-fidelity-2026-08-30`.
...
Fresh registry and repository search found no separate current typography/writing-mode research owner. The relevant existing owners are already broad enough:
