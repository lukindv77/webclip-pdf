# WebClip — fresh full-project research restart — C05 Geometry/layout — 2026-09-01
...
This document is a fresh-restart coverage/provenance checkpoint. `RESEARCH_REGISTRY.md` remains the single status authority for P-code owners. This evidence does not reopen/close an owner and does not change release readiness.
