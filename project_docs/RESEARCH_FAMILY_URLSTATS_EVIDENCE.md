# Research family evidence — derived `urlStats` generation and consumers

This document losslessly consolidates:

- `RESEARCH_DELTA_URLSTATS_REBUILD_ISOLATION_2026-08-27.md`;
- `RESEARCH_DELTA_URLSTATS_DIRTY_CONSUMER_FAILOPEN_2026-08-28.md`.
...
Both source deltas are fully represented here: source schedules, owner classification, generation acceptance and consumer fail-closed behavior are preserved. Their exact original prose and research baselines remain in Git history.
