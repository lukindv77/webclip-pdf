...
No independent root cause was established by PD3, so **no new P-code is allocated** and `AUDIT_REGISTRY.md` remains unchanged.
...
- `project_tools/audit_pseudo_top_layer_scroll_marker.py`
